    ...
    <StickyHeader>
      <div className="flex flex-col gap-6">
        <div className="flex justify-between items-center">
          <div>
            <h1 className="text-2xl font-bold text-primary-900 dark:text-primary-100">Q&A Knowledge Base</h1>
            <p className="text-primary-600 dark:text-primary-400">Manage and update the AI's knowledge foundation</p>
          </div>
